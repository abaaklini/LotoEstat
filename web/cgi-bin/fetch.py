...
def update_db (game='quina'):
    ...
    LOGFILENAME = '/home1/avaliamu/public_html/lotoestat/log/fetch.log'
    ...
    if filedb in list_of_files_inside_zip_file:
        ...
        fd = open('/home1/avaliamu/public_html/lotoestat/temp/' + filedb, 'w')
        fd.write(zip_file.read(filedb))
        fd.close()

        if not filecmp.cmp('/home1/avaliamu/public_html/lotoestat/temp/' + filedb,
                '/home1/avaliamu/public_html/lotoestat/data/' + filedb):
            logger.info('Arquivo %(arq)s sendo atualizado' % {'arq': filedb}) 
            shutil.copyfile('/home1/avaliamu/public_html/lotoestat/temp/' + filedb,
                    '/home1/avaliamu/public_html/lotoestat/data/' + filedb)
        else:
